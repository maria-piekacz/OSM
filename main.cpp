  ...
  fprintf(outputCSV,CSV_NAGLOWEK);
        ...
        while (1)
        {
          ...
          //  unsigned char Key = KEYBOARD.GetKey();
           ...
           RysujWykresyVER2(Zadana, Zadana - SprzezenieZwrotne,widocznosZadana, widocznoscUchyb, widocznoscObroty);
          

                                      //WYSWIETLANIE DANYCH TEXTOWYCH
                                      WyswietlDaneTextowe(Zadana, Zadana - SprzezenieZwrotne, Regulator->getOutput());
    ...
    void WyswietlDaneTextowe(int zadana, int uchyb, int sterujacy, int obroty){
    //WYŒWIETLENIE ZADANA
    textEkran[0]='Z';
    textEkran[1]='A';
    textEkran[2]='D';
